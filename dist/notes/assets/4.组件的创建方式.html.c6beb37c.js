import{e as n}from"./app.bfc0a8ee.js";import{_ as e}from"./plugin-vue_export-helper.21dcd24c.js";const s={},a=n(`<h2 id="_1-\u4F7F\u7528vue-extend" tabindex="-1"><a class="header-anchor" href="#_1-\u4F7F\u7528vue-extend" aria-hidden="true">#</a> 1.\u4F7F\u7528Vue.extend({})</h2><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>const temp = Vue.extend({
	name: &#39;temp&#39;,
	data: function(){
		return {
			&lt;!-- \u53D8\u91CF\uFF0C\u6570\u636E --&gt;
